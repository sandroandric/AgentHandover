...
class TestFeatureFlags:
    def test_all_enabled_by_default(self):
        ...
        from agenthandover_worker.main import _read_feature_flags
        with patch("agenthandover_worker.main._config_path", return_value=None):
    ...
    def test_single_feature_disabled(self, tmp_path):
        ...
        from agenthandover_worker.main import _read_feature_flags
        with patch("agenthandover_worker.main._config_path", return_value=str(config_path)):
            flags = _read_feature_flags()
