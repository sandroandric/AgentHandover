...
class TestAnthropicAvailability:
    def test_not_available_without_package(self):
        ...
        with patch.dict("sys.modules", {"anthropic": None}):
            from agenthandover_worker.backends.anthropic import AnthropicBackend
...
class TestAnthropicInfer:
    ...
    @patch("agenthandover_worker.backends.anthropic.run_with_timeout")
...
class TestMediaTypeDetection:
    def test_png_detection(self):
        from agenthandover_worker.backends.anthropic import _detect_media_type
