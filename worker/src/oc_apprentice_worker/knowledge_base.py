"""Knowledge base manager for ~/.openmimic/knowledge/.
...
DEFAULT_KNOWLEDGE_DIR = Path.home() / ".openmimic" / "knowledge"
...
class KnowledgeBase:
    """Manages ~/.openmimic/knowledge/ — atomic JSON read/write for all artifacts."""
