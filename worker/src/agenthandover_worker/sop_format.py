...
Implements sections 10.2-10.3 and 13.3 of the AgentHandover spec.  Each SOP is
...
class SOPFormatter:
    ...
    def format_sop(self, sop_template: dict) -> str:
        ...
        - sop_version: 1
        - sop_slug, sop_title
        - generated_by: "agenthandover v0.1.0"
    ...
    def _build_frontmatter(self, sop: dict, body_hash: str) -> dict:
        ...
        frontmatter: dict = {
            ...
            "generated_by": f"agenthandover v{self.VERSION}",
