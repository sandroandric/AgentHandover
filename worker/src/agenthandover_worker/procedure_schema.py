...
# Single source of truth: read from the package metadata. Used as
# ``generator_version`` in every saved procedure. Previously hardcoded
# to "0.2.0" and stale across three releases (every procedure written
# by v0.2.1/v0.2.2/v0.2.3 incorrectly claimed to be generated by
# worker v0.2.0). See ``agenthandover_worker/__init__.py``.
